...
Prompts for subdir and file name, then creates the note immediately
with TODO_STATE defaulted to WARNING -- so if you quit right after
picking the subdir, the file already exists on disk for real.
