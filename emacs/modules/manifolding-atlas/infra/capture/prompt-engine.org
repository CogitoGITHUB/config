...
contexts. Declarative buffer-UI prompts get deferred when
`my/manifolding-atlas-collect-defer' is bound; fast-mode declarative
prompts answer silently; everything else runs its prompt-fn directly.
#+begin_src emacs-lisp
