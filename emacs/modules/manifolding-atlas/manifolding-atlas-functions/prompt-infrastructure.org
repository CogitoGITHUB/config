...
Central registry so that adding a new .org to modules/manifolding-atlas/properties/ automatically
...
Search recursively under `properties/' for the file."
  (let* ((file (my/manifolding-atlas--help-file name))
         (properties-dir (expand-file-name "modules/manifolding-atlas/properties/"
