...
(define-module (substrate user-space root monitoring services grafana)
  ...
  #:use-module (substrate user-space root monitoring build utils)
  #:use-module (substrate user-space root monitoring services configuration)
