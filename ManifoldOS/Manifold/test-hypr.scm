...
;;; ============================================================================
;;; Wayland 1.25.0 (overrides upstream — needed by Hyprland 0.56)
;;; ============================================================================
...
;;; ============================================================================
;;; Wayland Protocols 1.49 (overrides upstream — needed by Hyprland 0.56)
;;; ============================================================================
...
(define-public hyprland
  (package
           ...
           #~(modify-phases %standard-phases
                (add-after 'unpack 'fix-path
                  (lambda* (#:key inputs #:allow-other-keys)
                      (invoke "sed" "-E" "-i"
                        "s/std::ranges::starts_with\\(([^,]+), ([^)]+)\\)/\\1.starts_with(\\2)/g"
    ...
    (native-inputs (list gcc-15 hyprwayland-scanner lua-5.5 python pkg-config))
    (inputs (list aquamarine))
    (propagated-inputs (list hyprgraphics hyprutils))
