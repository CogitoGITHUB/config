...
(define-module (test-pypi)
  #:use-module (Manifolding-OS import pypi)
  #:use-module (Manifolding-OS base32)
  #:use-module (Manifolding-OS memoization)
  #:use-module (Manifolding-OS utils)
  #:use-module ((Manifolding-OS base16) #:select (base16-string->bytevector))
  ...
  #:use-module ((Manifolding-OS diagnostics) #:select (guix-warning-port))
