...
(define-module (test-publish)
  #:use-module (Manifolding-OS scripts publish)
  ...
  #:use-module ((Manifolding-OS records) #:select (recutils->alist))
  #:use-module ((Manifolding-OS serialization) #:select (restore-file))
  #:use-module (gcrypt pk-crypto)
  #:use-module ((Manifolding-OS pki) #:select (%public-key-file %private-key-file))
  #:use-module (zlib)
  #:use-module (lzlib)
  ...
  #:use-module ((Manifolding-OS http-client) #:select (http-multiple-get))
