...
(use-modules (Manifolding-OS memoization)
             (Manifolding-OS monads)
             (Manifolding-OS graph)
             (Manifolding-OS packages)
             (Manifolding-OS profiles)
             (Manifolding-OS store)
             (Manifolding-OS transformations)
             (Manifolding-OS upstream)
             ((Manifolding-OS scripts build) #:select (dependents))
             ((Manifolding-OS scripts graph) #:select (%bag-node-type))
             ((Manifolding-OS import github) #:select (%github-api))
             (Manifolding-OS build-system gnu)
             (Manifolding-OS build-system cmake)
             ((gnu packages)
