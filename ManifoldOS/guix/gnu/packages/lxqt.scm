  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1rmfb6sgjf6xpbq5k9f0y6r5i7jzqvvvk2a3yhxa4878akwrz68l"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0yi8kq5wkgakbsqhad1m00b7fhdsv1yihinsakxpaqkvmr4mklil"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       '("-DBUILD_TESTS=ON"
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1bjz8iv94lkqagq9ry757r1bf7v4xqm0lnac2fvr29sqng8ks9kp"))))
    (build-system cmake-build-system)
    (inputs
     (list liblxqt))
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "02hpzwp0l7zq8yqnrx3lp2ll4ak7qnqafdzjdr1sdcmx1ghwbdqp"))))
    (build-system cmake-build-system)
    (inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "16iiz4gx0zxnqpbs3adz8kjrk7h567ka3xcdd4zq41mx6wivhzvg"))))
    (build-system cmake-build-system)
    (inputs
     (list liblxqt))
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1lhr3mgzwzqngwrn0dc3ljfvmbzm9a5x5sxp21gjbjr2nvz22njj"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "0mawbdk7ips7h2dy9fhzmfbw4y4wviazqihnrp50ik2hjjf5qk8s"))))
    (build-system cmake-build-system)
    (inputs
     (list liblxqt))
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "00x14zfn213d2hd9rhrplcqm8lrkx68n59xd5a9j3w2r6mjlvydp"))))
    (build-system cmake-build-system)
    (arguments
     (list
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "0iiqqkynrrv0d76wxc85qii0vnji75igrq21gzhdxlrrwqf1clfi"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "0q0351rcf5180jvblwvcyd3ksjchc4vms4c4hl7qqz79d3vcgp14"))))
    (build-system cmake-build-system)
    (inputs
     (list kidletime
           liblxqt
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "0icag2pk6igydxjdpfw5vv11bq87mi2c11wyscshxjrwc5rbadlc"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1avfhm960g12f8b0y8fpm18mlwa4rqq97wlg77ql90987dka3akl"))))
    (build-system cmake-build-system)
    (inputs
     (list liblxqt sudo))
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1yrjyjd1snkzj52krn5k8r35vm4ljqqjinj1f5s98nxgzph7b55k"))))
    (build-system cmake-build-system)
    (native-inputs
     (list lxqt-build-tools))
    (arguments '(#:tests? #f))          ; no tests
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1bwdnibb96q1q0drsswmxr6zld40frdvrypggi4010w1bb7imysk"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:tests? #f                       ; no tests
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "0dl654s8ayxvqln5x3jday2g8ykamh1pc0vn1nw12q14ycwr193w"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1033bg58g4j8akbmpa81rs5xv5kis11s2gfg41hbdwg954q3v0bz"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "012ky94jmhcgyxahp6kfghv8snb295n7idxna6vpa3nc3scx3dyf"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://github.com/lxqt/" name "/releases/download/"
                           version "/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1m1nhk5hvg52pcp6s68pfzavwvsd7k4c2v0gws4hn7zkyxgwzdmf"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1gvq6v6wp2bcj3y91d904yply55vc0a17c4wqw2jzcn3c6r2fgzl"))))
    (build-system cmake-build-system)
    (inputs
     (list kwindowsystem
           layer-shell-qt
