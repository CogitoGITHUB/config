...
def pytest_addoption(parser):
    ...
    More precisely, inject all options provided in .pytest_Manifolding-OS_options.json,
    ...
    """
    with open(".pytest_Manifolding-OS_options.json", "r") as options_file:
        plugin_options = json.load(options_file)
        group = parser.getgroup(
            "Manifolding-OS", "Options ignored by the Guix pyproject-build-system"
        )
