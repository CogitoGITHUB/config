lua << EOF
  ...
  for _, directory in pairs({"/run/current-system/profile", "~/.Manifolding-OS-profile", "~/.Manifolding-OS-home/profile", vim.env.GUIX_PROFILE, vim.env.GUIX_ENVIRONMENT}) do
