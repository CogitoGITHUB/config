...
(define-module (Manifolding-OS build-system meson)
...
(define (make-cross-file triplet)
  (computed-file (string-append "cross-" triplet ".ini")
    (with-imported-modules '((Manifolding-OS build meson-configuration))
      #~(begin
          (use-modules (Manifolding-OS build meson-configuration))
