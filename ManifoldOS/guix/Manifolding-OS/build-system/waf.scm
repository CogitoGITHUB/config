...
(define-module (Manifolding-OS build-system waf)
  ...
  #:use-module ((Manifolding-OS build-system python)
...
(define %waf-build-system-modules
  ...
  `((Manifolding-OS build waf-build-system)
...
(define* (waf-build name inputs
                    ...
                    (modules '((Manifolding-OS build waf-build-system)
