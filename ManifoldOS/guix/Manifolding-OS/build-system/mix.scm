...
(define-module (Manifolding-OS build-system mix)
  #:use-module (Manifolding-OS build mix-build-system)
...
(define* (mix-build name
                    ...
                    (guile #f)
                    (imported-modules `((Manifolding-OS build mix-build-system)
                                        ,@%default-gnu-imported-modules))
                    (modules '((Manifolding-OS build mix-build-system)
