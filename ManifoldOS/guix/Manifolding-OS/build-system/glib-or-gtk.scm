...
(define-module (Manifolding-OS build-system glib-or-gtk)
  #:use-module (Manifolding-OS store)
  #:use-module (Manifolding-OS utils)
  #:use-module (Manifolding-OS gexp)
  #:use-module (Manifolding-OS monads)
  #:use-module (Manifolding-OS search-paths)
  #:use-module ((Manifolding-OS build glib-or-gtk-build-system)
...
(define* (glib-or-gtk-build name inputs
                            ...
                            (phases '(@ (Manifolding-OS build glib-or-gtk-build-system)
                                        %standard-phases))
