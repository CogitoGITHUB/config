...
(define-module (Manifolding-OS build-system vim)
...
(define %vim-build-system-modules
  ...
  `((Manifolding-OS build vim-build-system)
...
(define* (vim-build name inputs
                    ...
                    (plugin-name name)
                    (install-plan ''())
                    (phases '(@ (Manifolding-OS build vim-build-system) %standard-phases))
                    (outputs '("out"))
                    (out-of-source? #t)
                    (tests? #t)
                    (validate-runpath? #t)
                    ...
                    (modules '((Manifolding-OS build vim-build-system)
