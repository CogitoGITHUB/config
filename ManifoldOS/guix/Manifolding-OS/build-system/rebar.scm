...
(define-module (Manifolding-OS build-system rebar)
...
(define %rebar-build-system-modules
  ...
  `((Manifolding-OS build rebar-build-system)
...
(define* (rebar-build name inputs
                       ...
                       (phases '(@ (Manifolding-OS build rebar-build-system)
                                   %standard-phases))
                       (outputs '("out"))
                       (search-paths '())
                       (native-search-paths '())
                       ...
                       (modules '((Manifolding-OS build rebar-build-system)
