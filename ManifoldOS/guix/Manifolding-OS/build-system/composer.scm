...
(define-module (Manifolding-OS build-system composer)
...
(define %composer-build-system-modules
  ...
  `((Manifolding-OS build composer-build-system)
...
(define* (composer-build name inputs
                         ...
                         (strip-directories #~'("lib" "lib64" "libexec"
                                               "bin" "sbin"))
                         (phases '(@ (Manifolding-OS build composer-build-system)
                                     %standard-phases))
                         (system (%current-system))
                         (imported-modules %composer-build-system-modules)
                         (modules '((Manifolding-OS build composer-build-system)
