...
(define-module (Manifolding-OS build-system android-ndk)
...
(define %android-ndk-build-system-modules
  ...
  `((Manifolding-OS build android-ndk-build-system)
...
(define* (android-ndk-build name inputs
                            ...
                            (modules '((Manifolding-OS build android-ndk-build-system)
