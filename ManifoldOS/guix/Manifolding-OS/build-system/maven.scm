...
(define-module (Manifolding-OS build-system maven)
...
(define %maven-build-system-modules
  ...
  `((Manifolding-OS build maven-build-system)
    (Manifolding-OS build maven pom)
...
(define* (maven-build name inputs
                      ...
                      (modules '((Manifolding-OS build maven-build-system)
                                 (Manifolding-OS build maven pom)
