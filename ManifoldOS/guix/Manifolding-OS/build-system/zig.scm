...
(define-module (Manifolding-OS build-system zig)
...
(define %zig-build-system-modules
  ...
  `((Manifolding-OS build zig-build-system)
    (Manifolding-OS build zig-utils)
...
(define* (zig-build name inputs
                    ...
                    (modules '((Manifolding-OS build zig-build-system)
                               (Manifolding-OS build utils))))
