...
(define-module (Manifolding-OS build-system hare)
...
(define %default-hare-imported-modules
  (cons '(Manifolding-OS build hare-build-system) %default-gnu-imported-modules))
(define %default-hare-modules
  '((Manifolding-OS build hare-build-system) (Manifolding-OS build utils)))
