...
(define-module (Manifolding-OS build-system dune)
  #:use-module (Manifolding-OS store)
  #:use-module (Manifolding-OS utils)
  #:use-module (Manifolding-OS gexp)
  #:use-module (Manifolding-OS search-paths)
  #:use-module (Manifolding-OS build-system)
  #:use-module ((Manifolding-OS build-system gnu) #:prefix gnu:)
  #:use-module ((Manifolding-OS build-system ocaml) #:prefix ocaml:)
...
(define %dune-build-system-modules
  ...
  `((Manifolding-OS build dune-build-system)
...
(define* (dune-build name inputs
                     ...
                     (phases '(@ (Manifolding-OS build dune-build-system)
                                 %standard-phases))
