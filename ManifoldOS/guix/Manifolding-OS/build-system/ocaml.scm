...
(define-module (Manifolding-OS build-system ocaml)
...
(define %ocaml-build-system-modules
  ...
  `((Manifolding-OS build ocaml-build-system)
...
(define (default-dune-build-system)
  ...
  (@* (Manifolding-OS build-system dune) dune-build-system))
...
(define* (ocaml-build name inputs
                      ...
                      (phases '(@ (Manifolding-OS build ocaml-build-system)
                                  %standard-phases))
                      (system (%current-system))
                      (imported-modules %ocaml-build-system-modules)
                      (modules '((Manifolding-OS build ocaml-build-system)
