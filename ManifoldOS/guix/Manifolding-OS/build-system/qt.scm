...
(define-module (Manifolding-OS build-system qt)
  #:use-module (Manifolding-OS store)
  #:use-module (Manifolding-OS utils)
  #:use-module (Manifolding-OS gexp)
  #:use-module (Manifolding-OS monads)
  #:use-module ((Manifolding-OS build qt-utils)
...
;; This barely is a copy from (Manifolding-OS build-system cmake), only adjusted to use
