...
(define-module (Manifolding-OS build-system python)
...
(define-deprecated/alias pypi-uri
  (@ (Manifolding-OS build-system pyproject) pypi-uri))

(define %python-build-system-modules
  ;; Build-side modules imported by default.
  `((Manifolding-OS build python-build-system)
    ...
    (cond
     ...
     ((or (eq? (package-build-system p) python-build-system)
          (eq? (package-build-system p)
               ;; Resolve lazily.
               (@* (Manifolding-OS build-system pyproject) pyproject-build-system)))
      (package/inherit p
...
(define* (python-build name inputs
                       ...
                       (modules '((Manifolding-OS build python-build-system)
