...
(define-module (Manifolding-OS remote)
  #:use-module (Manifolding-OS ssh)
  #:use-module (Manifolding-OS gexp)
  #:use-module (Manifolding-OS i18n)
  #:use-module ((Manifolding-OS diagnostics) #:select (info formatted-message))
...
result to the current output port using the (Manifolding-OS repl) protocol."
  (define program
    (program-file "remote-exp.scm" exp))

  (with-imported-modules (source-module-closure '((Manifolding-OS repl)))
    #~(begin
        (use-modules (Manifolding-OS repl))
