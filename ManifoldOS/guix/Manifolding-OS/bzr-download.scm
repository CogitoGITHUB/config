...
(define-module (Manifolding-OS bzr-download)
  #:use-module (Manifolding-OS gexp)
  #:use-module (Manifolding-OS modules)   ;for 'source-module-closure'
