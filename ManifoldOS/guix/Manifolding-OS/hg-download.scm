...
(define-module (Manifolding-OS hg-download)
...
(define (hg-fetch-builder hg hash-algo)
  ...
  (define modules
    (delete '(Manifolding-OS config)
            (source-module-closure '((Manifolding-OS build hg)
                                     (Manifolding-OS build download)
                                     (Manifolding-OS build download-nar)
                                     (Manifolding-OS swh)))))

  (with-imported-modules modules
    (with-extensions (list guile-json gnutls ;for (Manifolding-OS swh)
                           guile-lzlib)
      #~(begin
          (use-modules (Manifolding-OS build hg)
                       (Manifolding-OS build utils) ;for `set-path-environment-variable'
                       ((Manifolding-OS build download)
