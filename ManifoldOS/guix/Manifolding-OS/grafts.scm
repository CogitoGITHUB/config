...
are not recursively applied to dependencies of DRV."
  ...
  (define build
    (with-imported-modules '((Manifolding-OS build graft)
                             (Manifolding-OS build utils)
                             (Manifolding-OS build debug-link)
                             (Manifolding-OS elf))
      #~(begin
          (use-modules (Manifolding-OS build graft)
                       (Manifolding-OS build utils)
                       (ice-9 match))
