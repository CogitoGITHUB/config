...
(define-module (Manifolding-OS substitutes)
  ...
  #:autoload   (Manifolding-OS store deduplication) (dump-file/deduplicate)
...
(define %debug?
  ;; Enable debug mode by setting the MANIFOLDING_OS_SUBSTITUTE_DEBUG environmnent
  ;; variable.
  (make-parameter
   (getenv "MANIFOLDING_OS_SUBSTITUTE_DEBUG")))
