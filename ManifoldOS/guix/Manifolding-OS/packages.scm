...
(define-module (Manifolding-OS packages)
  #:autoload   (Manifolding-OS build utils) (compressor tarball? strip-store-file-name)
  ...
  #:autoload   (Manifolding-OS base64) (base64-decode)
...
(define-syntax validate-texinfo
  (let ((validate? (getenv "MANIFOLDING_OS_UNINSTALLED")))
