...
(define-module (Manifolding-OS gnu-maintenance)
  #:use-module (web uri)
  ...
  #:use-module ((Manifolding-OS http-client) #:hide (open-socket-for-uri))
  ;; not required in many cases, so autoloaded to reduce start-up costs.
  #:autoload   (Manifolding-OS download) (%mirrors)
  ...
  #:autoload   (Manifolding-OS import utils) (false-if-networking-error find-version)
