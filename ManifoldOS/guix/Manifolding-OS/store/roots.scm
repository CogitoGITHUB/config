...
(define-module (Manifolding-OS store roots)
  #:use-module (Manifolding-OS config)
  #:use-module ((Manifolding-OS store) #:select (store-path? %gc-roots-directory))
...
(define %profile-directory
  ...
  ;; XXX: This is redundant with the definition in (Manifolding-OS profiles) and not
