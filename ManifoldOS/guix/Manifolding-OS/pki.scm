...
(define-module (Manifolding-OS pki)
  #:use-module (Manifolding-OS config)
  #:use-module (gcrypt pk-crypto)
  #:use-module ((Manifolding-OS utils) #:select (with-atomic-file-output))
...
(define (public-keys->acl keys)
  "Return an ACL that lists all of KEYS with a '(Manifolding-OS import)'
