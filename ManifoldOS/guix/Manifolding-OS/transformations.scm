...
(define-module (Manifolding-OS transformations)
  #:use-module ((Manifolding-OS config) #:select (%system))
  ...
  #:autoload   (Manifolding-OS download) (download-to-store)
  #:autoload   (Manifolding-OS git-download) (git-reference?
                                    git-reference-url
                                    git-reference-recursive?)
  #:autoload   (Manifolding-OS git) (git-checkout
                           git-checkout?
                           git-checkout-url
                           git-checkout-recursive?)
  #:autoload   (Manifolding-OS upstream) (upstream-source
                                package-latest-release
                                preferred-upstream-source
                                upstream-source-version
                                upstream-source-signature-urls)
  #:autoload   (Manifolding-OS cpu) (current-cpu
