...
(define-module (Manifolding-OS git)
  #:use-module (git)
  ...
  #:autoload   (Manifolding-OS build syscalls) (terminal-string-width)
  #:use-module (Manifolding-OS gexp)
  #:autoload   (Manifolding-OS git-download)
  ...
  #:use-module ((Manifolding-OS diagnostics) #:select (leave warning info))
  #:use-module (Manifolding-OS progress)
  #:autoload   (Manifolding-OS swh) (swh-download commit-id?)
...
(define cached-checkout-expiration
  ...
  ;; TODO: Honor $MANIFOLDING_OS_GIT_CACHE_EXPIRATION.
...
(define* (latest-repository-commit* url #:key ref recursive? log-port)
  ...
  (lambda (store)
    ;; The caller--e.g., (Manifolding-OS scripts build)--may not handle 'git-error' so
