...
(define-module (Manifolding-OS upstream)
  ...
  #:use-module (Manifolding-OS gnupg)
  #:use-module (Manifolding-OS packages)
  #:use-module (Manifolding-OS diagnostics)
  #:use-module (Manifolding-OS ui)
  #:use-module (Manifolding-OS base32)
  #:use-module (Manifolding-OS gexp)
  #:autoload   (Manifolding-OS git) (latest-repository-commit git-reference->git-checkout)
  #:use-module (Manifolding-OS hash)
  #:use-module (Manifolding-OS store)
  #:use-module ((Manifolding-OS derivations) #:select (built-derivations derivation->output-path))
  #:autoload   (Manifolding-OS read-print) (object->string*)
...
(define (importer-modules)
  ...
  (cons (resolve-interface '(Manifolding-OS gnu-maintenance))
        (modules-from-current-profile "Manifolding-OS/import"
