...
(define-module (Manifolding-OS import hackage)
  ...
  #:use-module ((Manifolding-OS download) #:select (download-to-store url-fetch))
  #:use-module ((Manifolding-OS utils) #:select (package-name->name+version
  ...
  #:autoload   (Manifolding-OS build-system haskell) (hackage-uri)
  #:autoload   (Manifolding-OS build utils) (call-with-temporary-output-file)
  #:export (%hackage-url
