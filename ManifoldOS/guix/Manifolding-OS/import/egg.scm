...
(define-module (Manifolding-OS import egg)
  ...
  #:use-module (Manifolding-OS build-system chicken)
...
;;; Commentary:
;;;
;;; (Manifolding-OS import egg) provides package importer for CHICKEN eggs.  See the
...
not work."
  ...
  (if (not egg-content)
      ...
      (let* ((version* (or (assoc-ref egg-content 'version)
        ...
        ;; Copied from (Manifolding-OS import hackage).
