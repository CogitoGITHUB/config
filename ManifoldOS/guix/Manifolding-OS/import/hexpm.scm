...
(define-module (Manifolding-OS import hexpm)
  #:use-module (json)
  #:use-module (Manifolding-OS import utils)
  #:use-module ((Manifolding-OS import json) #:select (json-fetch))
  ...
  #:autoload   (Manifolding-OS utils) (file-sans-extension version>? version-prefix?)
