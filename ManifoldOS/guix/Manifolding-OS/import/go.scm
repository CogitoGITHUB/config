...
(define-module (Manifolding-OS import go)
  ...
  #:autoload   (Manifolding-OS ui) (warning)
...
;;; Commentary:
;;;
;;; (Manifolding-OS import go) attempts to make it easier to create Guix package
