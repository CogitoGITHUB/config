...
(define-module (Manifolding-OS import luanti)
  ...
  #:use-module ((Manifolding-OS packages) #:prefix package:)
...
MEDIA-LICENSE and LICENSE."
  `(package
     ...
     ;; patches to (Manifolding-OS upstream) that require some work) needs to know both
...
;; in (Manifolding-OS scripts import luanti) appropriately as well.
