...
(define-module (Manifolding-OS import print)
  #:use-module (Manifolding-OS base32)
  #:use-module (Manifolding-OS licenses)
  #:use-module (Manifolding-OS packages)
  #:use-module ((Manifolding-OS diagnostics) #:select (location-file))
...
when evaluated."
  ...
  (define (license->code lic)
    (let ((var (variable-name lic '(Manifolding-OS licenses))))
      (if var
      ...
      `(origin
         ...
         (method ,(or (any (lambda (module)
                           ...
                           '((Manifolding-OS download)
                             ...
                             (Manifolding-OS hg-download)
                             (Manifolding-OS svn-download)))
    ...
    `(define-public ,(string->symbol name)
       (package
         ...
         ,@(if replacement
               ...
               '())
         (build-system (@ (Manifolding-OS build-system ,(build-system-name build-system))
