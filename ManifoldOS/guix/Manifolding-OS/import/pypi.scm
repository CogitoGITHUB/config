...
(define-module (Manifolding-OS import pypi)
  ...
  #:autoload   (Manifolding-OS base16) (base16-string->bytevector)
  #:autoload   (Manifolding-OS base32) (bytevector->nix-base32-string)
  #:autoload   (Manifolding-OS derivations) (built-derivations
                                   derivation->output-path)
  #:autoload   (Manifolding-OS gexp) (lower-object)
  #:use-module ((Manifolding-OS download) #:select (download-to-store))
...
;; Adapted from SVN-COMMAND defined in (Manifolding-OS import texlive).
