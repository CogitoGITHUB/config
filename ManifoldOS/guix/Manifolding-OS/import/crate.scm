...
(define-module (Manifolding-OS import crate)
  ...
  #:use-module (Manifolding-OS scripts download)
     ...
     (call-with-output-string
       (lambda (port)
         (for-each
          ...
          `((use-modules (Manifolding-OS build-system cargo))
            ,@source-expressions
