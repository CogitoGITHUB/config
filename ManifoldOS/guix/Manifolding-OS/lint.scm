...
(define-module (Manifolding-OS lint)
  ...
  #:use-module ((Manifolding-OS ui) #:select (texi->plain-text fill-paragraph))
  #:use-module (Manifolding-OS gnu-maintenance)
  #:use-module (Manifolding-OS cve)
  #:use-module ((Manifolding-OS swh) #:hide (origin?))
  #:autoload   (Manifolding-OS git-download) (git-reference?
                                    git-reference-url git-reference-commit)
  #:autoload   (Manifolding-OS svn-download) (svn-reference?
                                    svn-reference-url
  ...
  #:autoload   (Manifolding-OS hg-download)  (hg-reference?
                                    hg-reference-url)
  #:autoload   (Manifolding-OS bzr-download) (bzr-reference?
                                    bzr-reference-url)
  #:use-module ((Manifolding-OS import pypi) #:select (pypi-ignored-inputs))
  #:use-module (Manifolding-OS import stackage)
  ...
  #:use-module (web uri)
  #:use-module ((Manifolding-OS build download)
