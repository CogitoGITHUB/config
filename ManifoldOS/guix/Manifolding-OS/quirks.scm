...
(define-module (Manifolding-OS quirks)
...
(define (syscalls-reexports-local-variables? source)
  "Return true if (Manifolding-OS build syscalls) contains the bug described at
...
(define %bug-41214-patch
  ;; Patch for <https://bugs.gnu.org/41214>.  Around v1.0.0, (Manifolding-OS build
