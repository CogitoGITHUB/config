...
(define-module (Manifolding-OS monad-repl)
  #:use-module (Manifolding-OS store)
  #:use-module (Manifolding-OS monads)
  #:use-module (Manifolding-OS utils)
  #:use-module (Manifolding-OS packages)
  #:autoload   (Manifolding-OS build-system) (bag)
  #:use-module (Manifolding-OS status)
  #:autoload   (Manifolding-OS gexp) (gexp gexp? lower-gexp lowered-gexp-sexp lower-object)
  #:use-module ((Manifolding-OS derivations)
                #:select (derivation?
                          derivation->output-paths built-derivations))
  #:autoload   (Manifolding-OS read-print) (pretty-print-with-comments)
...
(@ (Manifolding-OS store) set-build-options).  An example would be:
