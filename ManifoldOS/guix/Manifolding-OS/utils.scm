...
(define-module (Manifolding-OS utils)
  ...
  #:autoload   (Manifolding-OS build utils) (dump-port
                                   ...
                                   %xz-parallel-args)
  #:autoload   (Manifolding-OS build syscalls) (mkdtemp! fdatasync)
  #:autoload   (Manifolding-OS combinators) (fold2)
  #:use-module (Manifolding-OS diagnostics)           ;<location>, &error-location, etc.
...
(define (%guix-source-root-directory)
  ...
  (dirname (absolute-dirname "Manifolding-OS/packages.scm")))
