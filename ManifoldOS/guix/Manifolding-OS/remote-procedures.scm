...
(define-module (Manifolding-OS remote-procedures)
...
;;; is used to generate client stubs in (Manifolding-OS store) and can also be used to
...
procedure in (Manifolding-OS store roots), except that the 'find-roots' excludes
