...
(define-module (Manifolding-OS deprecation)
  #:use-module (Manifolding-OS i18n)
  #:use-module (Manifolding-OS diagnostics)
  #:autoload   (Manifolding-OS utils) (source-properties->location)
      ...
      ((_ visibility variable replacement exp)
       ...
       (with-syntax ((real (datum->syntax
         ...
         #`(begin
             ...
             ;; so that the (Manifolding-OS discover) machinery finds it.
