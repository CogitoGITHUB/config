...
(define-module (Manifolding-OS scripts publish)
  ...
  #:autoload   (Manifolding-OS avahi) (avahi-publish-service-thread)
  ...
  #:use-module ((Manifolding-OS serialization) #:select (write-file))
  #:use-module (zlib)
  ...
  #:use-module ((Manifolding-OS build syscalls) #:select (set-thread-name))
