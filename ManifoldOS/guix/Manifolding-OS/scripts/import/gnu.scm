...
(define-module (Manifolding-OS scripts import gnu)
  #:use-module (Manifolding-OS ui)
  #:use-module (Manifolding-OS utils)
  #:use-module (Manifolding-OS scripts)
  #:use-module (Manifolding-OS import gnu)
  #:use-module (Manifolding-OS scripts import)
...
Return a package declaration template for PACKAGE, a GNU package.\n"))
  ;; '--key-download' taken from (Manifolding-OS scripts refresh).
  (display (G_ "
      --key-download=POLICY
...
(define %options
  ...
  (cons* (option '(#\h "help") #f #f
         ...
         (option '("key-download") #t #f          ;from (Manifolding-OS scripts refresh)
