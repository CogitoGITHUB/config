...
(define-module (Manifolding-OS scripts system)
  ...
  #:autoload   (Manifolding-OS base16) (bytevector->base16-string)
  #:autoload   (Manifolding-OS store database)
               (register-valid-path store-database-file call-with-database)
  #:autoload   (Manifolding-OS build store-copy) (copy-store-item)
  ...
  #:autoload   (Manifolding-OS scripts package) (delete-generations
                                       delete-matching-generations
                                       list-installed)
  #:autoload   (Manifolding-OS scripts system installer) (guix-system-installer)
  #:autoload   (Manifolding-OS graph) (export-graph node-type
  ...
  #:autoload   (Manifolding-OS progress) (progress-reporter/bar
...
(define (resolve-subcommand name)
  (let ((module (resolve-interface
                 `(Manifolding-OS scripts system ,(string->symbol name))))
