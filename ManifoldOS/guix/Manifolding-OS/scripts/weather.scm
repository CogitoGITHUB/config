...
(define-module (Manifolding-OS scripts weather)
  ...
  #:autoload   (Manifolding-OS build download) (default-connection-establishment-timeout)
  #:use-module ((Manifolding-OS build syscalls) #:select (terminal-columns))
  #:use-module ((Manifolding-OS build utils) #:select (every*))
  ...
  #:use-module (Manifolding-OS ci)
  #:use-module (Manifolding-OS sets)
  #:use-module (Manifolding-OS graph)
