...
(define-module (Manifolding-OS scripts challenge)
...
(define ensure-store-item                         ;XXX: move to (Manifolding-OS ui)?
  (@@ (Manifolding-OS scripts size) ensure-store-item))
