...
(define-module (Manifolding-OS scripts graph)
  ...
  #:use-module ((Manifolding-OS build-system gnu) #:select (standard-packages))
...
(define intern
  (mlambda (str)
    ...
    ;; because their nodes are strings but the (Manifolding-OS graph) traversal
