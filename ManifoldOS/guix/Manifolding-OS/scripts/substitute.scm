...
(define %allow-unauthenticated-substitutes?
  ...
  (make-parameter
   (and=> (getenv "MANIFOLDING_OS_ALLOW_UNAUTHENTICATED_SUBSTITUTES")
          (cut string-ci=? <> "yes"))))
...
(define %allow-unsafe-substitute-uris?
  ...
  ;; attacker-controlled location.  Use MANIFOLDING_OS_ALLOW_UNAUTHENTICATED_SUBSTITUTES
...
;; XXX: copied from (Manifolding-OS utils)
               ...
               (let ((narinfo
                 ...
                 (if expected-hash
                     (begin
                       ...
                       ;; leave it up to (Manifolding-OS status) to prettify things.
                       (newline (current-error-port))
