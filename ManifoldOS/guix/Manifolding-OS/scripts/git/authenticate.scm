...
(define-module (Manifolding-OS scripts git authenticate)
  #:use-module (git)
  ...
  #:autoload   (Manifolding-OS openpgp) (openpgp-fingerprint->bytevector
                               openpgp-format-fingerprint
                               openpgp-public-key-fingerprint)
  #:use-module ((Manifolding-OS git) #:select (with-git-error-handling))
