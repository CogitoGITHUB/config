...
(define-module (Manifolding-OS scripts perform-download)
  #:use-module (Manifolding-OS ui)
  #:use-module (Manifolding-OS scripts)
  #:use-module (Manifolding-OS derivations)
  #:use-module ((Manifolding-OS store) #:select (derivation-path? store-path?))
  #:use-module ((Manifolding-OS build utils) #:select (store-file-name?
                                             strip-store-file-name))
  #:autoload   (Manifolding-OS build download) (%download-methods url-fetch)
  #:autoload   (Manifolding-OS build git) (git-fetch-with-fallback)
  #:autoload   (Manifolding-OS config) (%git)
...
(define %safe-bindings
  `( ;; Historically used, must be available for backwards compatibility
    ((guile)
     ...
     (noop . current-module))
    ((Manifolding-OS base16) bytevector->base16-string base16-string->bytevector)
    ...
    ((Manifolding-OS scripts perform-download)
