...
(define-module (Manifolding-OS scripts shell)
  #:use-module (Manifolding-OS ui)
  #:use-module ((Manifolding-OS diagnostics) #:select (location))
  #:use-module (Manifolding-OS scripts environment)
  #:autoload   (Manifolding-OS scripts build) (show-build-options-help
                                     show-native-build-options-help)
  #:autoload   (Manifolding-OS transformations) (options->transformation
  ...
  #:autoload   (Manifolding-OS base32) (bytevector->base32-string)
  #:autoload   (rnrs bytevectors) (string->utf8)
  #:autoload   (Manifolding-OS utils) (config-directory cache-directory)
...
Return the modified OPTS."
  ...
  (if (or (not interactive?)
      ...
      opts
      (match (find-file-in-parent-directories '("manifest.scm" "Manifolding-OS.scm"))
        (#f
        ...
        (file
         (if (authorized-shell-directory? (dirname file))
             (begin
               ...
               (match (basename file)
                 ("Manifolding-OS.scm" (alist-cons 'load `(package ,file) opts))
