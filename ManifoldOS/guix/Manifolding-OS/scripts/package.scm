...
(define-module (Manifolding-OS scripts package)
  #:use-module (Manifolding-OS ui)
  #:use-module ((Manifolding-OS status) #:select (with-status-verbosity))
  #:use-module ((Manifolding-OS build syscalls) #:select (terminal-rows))
  ...
  #:autoload   (Manifolding-OS store roots) (gc-roots user-owned?)
...
@example
MANIFOLDING_OS_PROFILE=\"~a\"
. \"$MANIFOLDING_OS_PROFILE/etc/profile\"
