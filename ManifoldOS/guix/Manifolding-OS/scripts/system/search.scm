...
(define-module (Manifolding-OS scripts system search)
  #:use-module (Manifolding-OS ui)
  #:use-module (Manifolding-OS utils)
  #:autoload   (Manifolding-OS colors) (color-output? highlight supports-hyperlinks?)
  #:autoload   (Manifolding-OS diagnostics) (location->hyperlink)
