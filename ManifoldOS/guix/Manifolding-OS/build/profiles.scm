...
(define-module (Manifolding-OS build profiles)
...
'MANIFOLDING_OS_PROFILE' environment variable.  This allows users to specify what the
user-friendly name of the profile is, for instance ~/.guix-profile rather than
/gnu/store/...-profile."
  (let ((replacement (string-append "${MANIFOLDING_OS_PROFILE:-" profile "}"))
...
definitions for all the SEARCH-PATHS."
  ...
  (call-with-output-file file
    (lambda (port)
      ;; The use of $MANIFOLDING_OS_PROFILE described below is not great.  Another
...
# for this profile.  You may want to define the 'MANIFOLDING_OS_PROFILE' environment
# variable to point to the \"visible\" name of the profile, like this:
#
#  MANIFOLDING_OS_PROFILE=/path/to/profile ; \\
#  source /path/to/profile/etc/profile
#
# When MANIFOLDING_OS_PROFILE is undefined, the various environment variables refer
