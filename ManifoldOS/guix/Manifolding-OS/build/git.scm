...
(define-module (Manifolding-OS build git)
  #:use-module (Manifolding-OS build utils)
  #:use-module ((Manifolding-OS build download)
                #:select (download-method-enabled?))
  #:autoload   (Manifolding-OS build download-nar) (download-nar)
  #:autoload   (Manifolding-OS swh) (%verify-swh-certificate?
                           swh-download
...
;;; Commentary:
;;;
;;; This is the build-side support code of (Manifolding-OS git-download).  It allows a
