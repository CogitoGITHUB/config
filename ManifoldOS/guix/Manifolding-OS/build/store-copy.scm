...
(define-module (Manifolding-OS build store-copy)
  #:use-module ((Manifolding-OS build utils) #:hide (copy-recursively))
  #:use-module (Manifolding-OS sets)
  #:use-module (Manifolding-OS progress)
  #:autoload   (Manifolding-OS store deduplication) (copy-file/deduplicate)
...
;; TODO: Factorize with that in (Manifolding-OS store).
...
;; TODO: Remove when the one in (Manifolding-OS build utils) has #:keep-permissions?,
