...
(define-module (Manifolding-OS build pack)
  #:use-module (gnu build install)
  #:use-module (Manifolding-OS build utils)
  #:use-module (Manifolding-OS build store-copy)
  #:use-module ((Manifolding-OS build union) #:select (relative-file-name))
...
;;; (Manifolding-OS scripts pack) module, mostly to allow for code reuse.  Due to making
;;; use of the (Manifolding-OS build store-copy) module, it transitively requires the
...
(define (assert-utf8-locale)
  ...
  (unless (string=? "unset for tests" (or (getenv "MANIFOLDING_OS_LOCPATH") ""))
