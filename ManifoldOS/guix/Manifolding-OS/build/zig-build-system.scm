...
(define (unpack-dependencies . _)
  "Unpack Zig dependencies from MANIFOLDING_OS_ZIG_PACKAGE_PATH."
  (define zig-inputs
    (append-map
     (lambda (directory)
     ...
     (or (and=> (getenv "MANIFOLDING_OS_ZIG_PACKAGE_PATH")
                (cut string-split <> #\:))
         '())))
