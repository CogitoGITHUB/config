...
(define-module (Manifolding-OS build clojure-build-system)
  #:use-module ((Manifolding-OS build ant-build-system)
                #:select ((%standard-phases . %standard-phases@ant)
                          ant-build))
  #:use-module (Manifolding-OS build clojure-utils)
  #:use-module (Manifolding-OS build java-utils)
