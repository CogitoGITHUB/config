...
(define-module (Manifolding-OS build meson-build-system)
  #:use-module ((Manifolding-OS build gnu-build-system) #:prefix gnu:)
  #:use-module ((Manifolding-OS build glib-or-gtk-build-system) #:prefix glib-or-gtk:)
...
(define %standard-phases
  ...
  ;; then the extra phases will be removed again in (Manifolding-OS build-system meson).
