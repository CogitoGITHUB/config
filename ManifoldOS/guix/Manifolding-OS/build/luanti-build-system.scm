...
(define-module (Manifolding-OS build luanti-build-system)
  ...
  #:use-module ((Manifolding-OS build copy-build-system) #:prefix copy:)
  #:export (%standard-phases
            mod-install-plan minimise-png read-mod-name check))

;; (Manifolding-OS build copy-build-system) does not export 'install'.
(define copy:install
...
" port)
      ...
      (receive (port pid)
          ((@@ (Manifolding-OS build utils) open-pipe-with-stderr)
