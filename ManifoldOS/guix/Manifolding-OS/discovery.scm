...
(define-module (Manifolding-OS discovery)
  #:use-module (Manifolding-OS i18n)
  #:use-module (Manifolding-OS modules)
  #:use-module (Manifolding-OS combinators)
  #:autoload   (Manifolding-OS build syscalls) (scandir*)
...
name and the exception key and arguments."
  ...
  (parameterize ((current-warning-port (if (getenv "MANIFOLDING_OS_UNINSTALLED")
