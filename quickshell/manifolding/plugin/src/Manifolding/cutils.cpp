...
Q_LOGGING_CATEGORY(lcCUtils, "manifolding.cutils", QtInfoMsg)

namespace manifolding {
...
#ifndef MANIFOLDING_VERSION
#define MANIFOLDING_VERSION ""
#endif

QString CUtils::version() const {
    return QStringLiteral(MANIFOLDING_VERSION);
}
