...
namespace manifolding::services {
...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(manifolding::services::LyricsBackend::Backend backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(manifolding::services::LyricsBackend::Backend preferredBackend READ preferredBackend WRITE
            setPreferredBackend NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<manifolding::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(manifolding::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
