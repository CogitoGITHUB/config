...
class Storage : public TickingService {
    ...
    Q_PROPERTY(QQmlListProperty<manifolding::services::DiskInfo> disks READ disksProp NOTIFY disksChanged)
    Q_PROPERTY(manifolding::services::DiskInfo* manualPrimaryDisk READ manualPrimaryDisk WRITE setManualPrimaryDisk NOTIFY
            manualPrimaryDiskChanged)
    Q_PROPERTY(manifolding::services::DiskInfo* primaryDisk READ primaryDisk NOTIFY primaryDiskChanged)
