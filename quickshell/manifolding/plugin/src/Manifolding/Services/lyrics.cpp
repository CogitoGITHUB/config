...
Q_LOGGING_CATEGORY(lcLyrics, "manifolding.lyrics", QtInfoMsg)
...
[[nodiscard]] const QHash<QByteArray, QByteArray>& lrclibHeaders() {
    static const QHash<QByteArray, QByteArray> h = {
        { "User-Agent"_ba, "manifolding-shell (https://github.com/caelestia-dots/shell)"_ba },
    };
    return h;
}
...
const QString& Lyrics::stateDir() {
    static const QString s_dir = [] {
        ...
        return state + u"/manifolding/lyrics"_s;
    }();
    return s_dir;
}
...
const QString& Lyrics::cacheDir() {
    static const QString s_dir = [] {
        ...
        return cache + u"/manifolding/lyrics"_s;
    }();
    return s_dir;
}
