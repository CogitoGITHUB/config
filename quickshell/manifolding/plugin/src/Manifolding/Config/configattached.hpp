...
class Config : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const manifolding::config::AppearanceConfig* appearance READ appearance NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::GeneralConfig* general READ general NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::BackgroundConfig* background READ background NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::BarConfig* bar READ bar NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::BorderConfig* border READ border NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::DashboardConfig* dashboard READ dashboard NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::LauncherConfig* launcher READ launcher NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::LockConfig* lock READ lock NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::NexusConfig* nexus READ nexus NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::NotifsConfig* notifs READ notifs NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::OsdConfig* osd READ osd NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::ServiceConfig* services READ services NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::SessionConfig* session READ session NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::SidebarConfig* sidebar READ sidebar NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::UtilitiesConfig* utilities READ utilities NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::WInfoConfig* winfo READ winfo NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::UserPaths* paths READ paths NOTIFY sourceChanged)
