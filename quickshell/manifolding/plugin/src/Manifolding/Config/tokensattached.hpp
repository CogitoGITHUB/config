...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const manifolding::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::AppearanceSpacing* spacing READ spacing NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::AppearancePadding* padding READ padding NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::AppearanceTransparency* transparency READ transparency NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::SizeTokens* sizes READ sizes NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::FontTokens* font READ font NOTIFY sourceChanged)
    Q_PROPERTY(const manifolding::config::AnimTokens* anim READ anim NOTIFY sourceChanged)
