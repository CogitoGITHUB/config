...
$env.config = {
    ...
    explore: {
        ...
        status: {
            error: { fg: "white", bg: "white" },
            warn: {}
            info: {}
        },
        selected_cell: { bg: grey },
    }
...
#    filesize: {
 #       metric:  # true => KB, MB, GB (ISO standard), false => KiB, MiB, GiB (Windows standard)
  #      format: "" # b, kb, kib, mb, mib, gb, gib, tb, tib, pb, pib, eb, eib, auto
   # }
